...
A website to query the [PoetryDB](https://poetrydb.org), adapted from the Angular [first-app](https://angular.dev/tutorials/first-app) and [signals](https://angular.dev/tutorials/signals) tutorials. Testing configuration adapted from the Angular [Testing](https://angular.dev/guide/testing) guide.
